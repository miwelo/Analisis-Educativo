...
class ExportedApp(ctk.CTk):
    ...
    def _build_static_ui(self):
        ...
        self.csv_icon = load_image("2.png", (25, 25))
        ...
        self.destino_icon = load_image("3.png", (25, 25))
